...
module.exports = function( sequelize, DataTypes ){
        var post = sequelize.define('Post',{
            ...
            path_of_images: {type: DataTypes.STRING(20), allowNull: false},
            created_date: {type: DataTypes.DATEONLY, allowNull: false}
        });

        post.associate = (models) => {
            post.belongsTo(models.User_profile, {foreignKey: 'user_profile_fk', unique: true, targetKey: 'user_profile_id'});
