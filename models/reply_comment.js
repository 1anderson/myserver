...
module.exports = function(sequelize, DataTypes){
    ...
    replyComment.associate = function(models){
        replyComment.belongsTo(models.Comment, {foreignKey: 'comment_fk', unique: true, targetKey: 'id'});
        replyComment.belongsTo(models.User_profile, {foreignKey: 'user_profile_fk', unique: true, targetKey: 'id'});
    };
